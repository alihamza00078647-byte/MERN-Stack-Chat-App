      ...
      {/* Bottom Area To Send Messages */}
        <div className="absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3">
            <div className="flex-1 flex items-center bg-gray-100/12 rounded-full px-3">
                <input type="text" placeholder="Send a message" className="flex-1 text-sm border-none outline-none text-white p-3 placeholder-gray-400" />
                <input type="file" className="" id="image" accept=".png, .jpg, .jpeg" hidden />
                <label htmlFor="image">
